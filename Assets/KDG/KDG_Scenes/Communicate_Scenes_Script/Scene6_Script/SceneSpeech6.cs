...
public class SceneSpeech6 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        AddSpeech(speechObject9, speechPosition9);  // 다섯 번째 대사
        AddSpeech(speechObject10, speechPosition10);  // 여섯 번째 대사
        AddSpeech(speechObject11, speechPosition11);  // 일곱 번째 대사
        AddSpeech(speechObject12, speechPosition12);  // 여덟 번째 대사
        AddSpeech(speechObject13, speechPosition13);  // 일곱 번째 대사
